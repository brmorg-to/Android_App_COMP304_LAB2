...
class Condominium : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_condominium, container, false)
        var selections = arrayListOf<String>()
        val checkout = view.findViewById<Button>(R.id.detachedCheckoutButton)

        checkout.setOnClickListener{
            selections.add(view.findViewById<TextView>(R.id.condominiumHeader).text.toString())
            ...
            if(selections.count() < 2) {
                ...
                Log.d("Condominium,", "Selected Condominium(s): $selectedOptionsString")
